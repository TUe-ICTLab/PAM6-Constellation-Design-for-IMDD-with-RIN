...
%% (4.1) Simulation of post-FEC BER ext. Hamming Code
if isempty(gcp('nocreate'))
    parpool(6);
end

load('QAM36_idx2rmv.mat');
ix2rmv = [233 185 119];% 313];		% [Framed-Cross=212, Cross=185, RIN=119]
N_ix = length(ix2rmv);
...
X_set_2D_vec = X_set_2D_vec_N(:,ix);
...
legend('Pre-FEC BER', 'Post-FEC BER (HD)', 'Post-FEC BER (SD)');
